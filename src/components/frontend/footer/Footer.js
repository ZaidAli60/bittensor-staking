    ...
    return (
        <footer className={`text-center footer dashboard ${theme}`}>
            <div className='mb-5'>
                ...
                <p className={`mb-1 fw-bold fontFamily ${theme === 'dark' && 'text-white'}`} style={{ fontSize: "1rem" }}>Copyright &copy; {window.year} <span><a className='text-decoration-none' href="https://bittensorstaking.com" target="_blank" rel="noopener noreferrer"> BittensorStaking.com </a></span></p>
            </div>
        </footer>
    )
}
